  ...
  return (
    ...
    >
      {groups.map((group, index) => (
        ...
        >
          <h3 className={cx('text-lg font-extrabold uppercase', dark ? 'text-lokambe-peach' : 'text-lokambe-blue')}>
            {group.title}
          </h3>
              ...
              <li
                ...
                className={cx(
                  variant === 'chips'
                    ...
                    : cx('flex gap-3 text-[1.0625rem] leading-snug', dark ? 'text-white/80' : 'text-ink-soft'),
                )}
              >
                {variant === 'bullets' && (
